...
Received photo`,
    ...
    'enter-message':
      'Enter the message for the user. (max. 400 chars)',
...
Note:
Use a language you can read and understand.
Old messages (sent and received) will not be changed to new language.
