...
describe("Models Test", function() {
  ...
  describe("[Wallet]", function() {
    ...
    it("should create a new address for currency", async function() {
      for (let i = 0; i < createdUser.wallets.length; i++) {
        ...
        let updatedWallet: Wallets | null = await Wallets.findOne({
  ...
  describe("[Transactions]", function() {
    ...
    it("should increase available balance on deposit confirmed transaction", async function() {
      let createDepositFirst: Transaction | null = await Transaction.create<
        Transaction
      >({
      ...
      let createDepositFirst_1: Transaction | null = await Transaction.create<
        Transaction
      >({
        userId: createdUser.id,
        transactionType: "receive",
      ...
      let createDepositSecond: Transaction | null = await Transaction.create<
        Transaction
      >({
        userId: createdUser.id,
        transactionType: "receive",
      ...
      let createDepositSecond_1: Transaction | null = await Transaction.create<
        Transaction
      >({
        userId: createdUser.id,
        transactionType: "receive",
      ...
      let newWalletFirst: Wallets | null = await Wallets.findOne({
        where: { currencyCode: firstCoin, userId: createdUser.id }
      });
      let newWalletSecond: Wallets | null = await Wallets.findOne({
        where: { currencyCode: secondCoin, userId: createdUser.id }
      });
    ...
    it("should decrease available balance on withdraw", async function() {
      let createWithdrawFirst: Transaction | null = await Transaction.create<
        Transaction
      >({
        userId: createdUser.id,
        transactionType: "receive",
      ...
      let createWithdrawFirst_1: Transaction | null = await Transaction.create<
        Transaction
      >({
        userId: createdUser.id,
      ...
      let createWithdrawSecond: Transaction | null = await Transaction.create<
        Transaction
      >({
        userId: createdUser.id,
        transactionType: "receive",
      ...
      let createWithdrawSecond_1: Transaction | null = await Transaction.create<
        Transaction
      >({
        userId: createdUser.id,
        transactionType: "send",
  ...
  describe("[Payments]", function() {
    ...
    it("should update blocked balance on successful create payment", async function() {
      let tx = await Transaction.create<Transaction>({
        userId: createdUser.id,
        transactionType: "receive",
        amount: 0.32,
        confirmations: 2,
      ...
      let p = await Transfer.newPayment(
        createdUser.id,
    ...
    it("should update balance on successful claim", async function() {
      ...
      let wallet1 = await Wallet.findOne({
        where: { currencyCode: firstCoin, userId: createdUser.id }
      });
      let wallet2 = await Wallet.findOne({
      ...
      let payment = await Transfer.findOne({
